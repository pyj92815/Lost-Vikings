...
void stageScene::render()
{
	...
	IMAGEMANAGER->findImage("UI_Image")->render(getMemDC(), 0, WINSIZEY / 2 + 105);
...
void stageScene::addStageImage()
{
	...
	IMAGEMANAGER->addImage("GarbageBox", "./image/UI/UI_Inventory/Garbage_Box.bmp", 30, 32, false, RGB(0, 0, 0));
